...
\begin{itemize}
      ...
      \item There are some papers that even made headlines in news that used low quality imputed SNPs. % that could be problamatic.
...
\begin{figure}
      ...
      % \includegraphics[width= .3\textwidth]{fig/DS-0-i75.png}
      % \includegraphics[width= .3\textwidth]{fig/DS-0-i99.png}
...
\begin{figure}
      ...
      % \includegraphics[width= .3\textwidth]{fig/DS-1-i75.png}
      % \includegraphics[width= .3\textwidth]{fig/DS-1-i99.png}
...
\begin{figure}
      ...
      % \includegraphics[width= .3\textwidth]{fig/DS-2-i75.png}
      % \includegraphics[width= .3\textwidth]{fig/DS-2-i99.png}
...
% \begin{frame}{Distributions Conditional on IBD states}{Full Siblings - Hard Calls - IBD = 0}

% \begin{figure}

%       \includegraphics[width= .3\textwidth]{fig/HC-0-i30.png}
%       \includegraphics[width= .3\textwidth]{fig/HC-0-i75.png}
%       \includegraphics[width= .3\textwidth]{fig/HC-0-i99.png}
...
% \begin{frame}{Distributions Conditional on IBD states}{Full Siblings - Hard Calls - IBD = 1}

% \begin{figure}

%       \includegraphics[width= .3\textwidth]{fig/HC-1-i30.png}
%       \includegraphics[width= .3\textwidth]{fig/HC-1-i75.png}
%       \includegraphics[width= .3\textwidth]{fig/HC-1-i99.png}
...
% \begin{frame}{Distributions Conditional on IBD states}{Full Siblings - Hard Calls - IBD = 2}

% \begin{figure}

%       \includegraphics[width= .3\textwidth]{fig/HC-2-i30.png}
%       \includegraphics[width= .3\textwidth]{fig/HC-2-i75.png}
%       \includegraphics[width= .3\textwidth]{fig/HC-2-i99.png}
